...
(() => {
    var C = {
                    ...
                    function Open() {
                        return (0, L.default)(this, Open),
                            function _callSuper(C, T, B) {
                                return T = (0, $.default)(T), (0, W.default)(C, _isNativeReflectConstruct() ? Reflect.construct(T, B || [], (0, $.default)(C).constructor) : T.apply(C, B))
                            }(this, Open, arguments)
                    }
                    return (0, V.default)(Open, C), (0, U.default)(Open, [{
                        key: "apply",
            ...
            13452: (C, T, B) => {
                ...
                var K = T.ForceMethodImplementation = function(C) {
                    ...
                    return (0, V.default)(ForceMethodImplementation, C), (0, L.default)(ForceMethodImplementation)
                }((0, H.default)(Error));
            ...
            30735: (C, T, B) => {
                ...
                var H = T.Load = function(C) {
                    function Load() {
                        return (0, L.default)(this, Load),
                            function _callSuper(C, T, B) {
                                return T = (0, $.default)(T), (0, W.default)(C, _isNativeReflectConstruct() ? Reflect.construct(T, B || [], (0, $.default)(C).constructor) : T.apply(C, B))
                            }(this, Load, arguments)
                    }
                    return (0, V.default)(Load, C), (0, U.default)(Load, [{
                        key: "apply",
                        value: function apply(C) {
            ...
            40397: (C, T, B) => {
                ...
                function _callSuper(C, T, B) {
                    return T = (0, H.default)(T), (0, V.default)(C, _isNativeReflectConstruct() ? Reflect.construct(T, B || [], (0, H.default)(C).constructor) : T.apply(C, B))
                }
                ...
                T.default = function(C) {
                    function ComponentBase() {
                        return (0, W.default)(this, ComponentBase), _callSuper(this, ComponentBase, arguments)
                    }
                    return (0, K.default)(ComponentBase, C), (0, $.default)(ComponentBase, [{
                        key: "__construct",
                        ...
                        value: function registerCommand(C, T) {
                            ...
                            !!T.getInstanceType && T.getInstanceType() || ($e.devTools && $e.devTools.log.warn("Attach command-callback-base, on command: '".concat(q, "', context is unknown type.")), L.callback = T, T = function(C) {
                                function context() {
                                    return (0, W.default)(this, context), _callSuper(this, context, arguments)
                                }
                                return (0, K.default)(context, C), (0, $.default)(context)
            ...
            41019: (C, T, B) => {
                ...
                T.default = function(C) {
                    ...
                    return (0, V.default)(CommandCallbackBase, C), (0, U.default)(CommandCallbackBase, [{
                        key: "apply",
            ...
            49175: (C, T, B) => {
                ...
                var U = q(B(39805)),
                    ...
                    X = function _interopRequireWildcard(C, T) {
                        ...
                        return function _interopRequireWildcard(C, T) {
                            ...
                            for (var V in C) "default" !== V && {}.hasOwnProperty.call(C, V) && ((W = (U = Object.defineProperty) && Object.getOwnPropertyDescriptor(C, V)) && (W.get || W.set) ? U($, V, W) : $[V] = C[V]);
                            return $
                        }(C, T)
                    }(B(7375));
                ...
                T.default = function(C) {
                    function Component() {
                        return (0, U.default)(this, Component),
                            function _callSuper(C, T, B) {
                    ...
                    return (0, H.default)(Component, C), (0, W.default)(Component, [{
                        key: "getNamespace",
                        value: function getNamespace() {
                            return "app"
                        }
                ...
                var nanoid = function(C) {
                    ...
                    miniSerializeError = function(C) {
                        if ("object" == typeof C && null !== C) {
                            for (var T = {}, B = 0, q = Ce; B < q.length; B++) {
                                var L = q[B];
                                        ...
                                        return __async(this, null, function() {
                                            ...
                                            return __generator(this, function(te) {
                                                switch (te.label) {
                                                    ...
                                                    case 4:
                                                        return ee = te.sent(), Q = ee instanceof Me ? U(null, X, C, ee.payload, ee.meta) : U(ee, X, C), [3, 5];
                                                    case 5:
                    ...
                    return (0, U.default)(InstanceType, null, [{
                        ...
                        value: function value(C) {
                            var T = function _superPropGet(C, T, B, q) {
                                var L = (0, $.default)((0, W.default)(1 & q ? C.prototype : C), T, B);
            ...
            76535: (C, T, B) => {
                ...
                var H = T.Close = function(C) {
                    ...
                    return (0, V.default)(Close, C), (0, U.default)(Close, [{
                        key: "apply",
                        value: function apply() {
            ...
            79958: (C, T, B) => {
                ...
                var G = T.default = function(C) {
                    ...
                    return (0, V.default)(CommandInfra, C), (0, U.default)(CommandInfra, [{
                        key: "currentCommand",
                        get: function get() {
                ...
                (0, H.default)(G, "registerConfig", null)
            },
            82946: (C, T, B) => {
                "use strict";
                var q = B(96784);
                ...
                T.default = function(C) {
                    ...
                    return (0, H.default)(ArgsObject, C), (0, W.default)(ArgsObject, [{
                        key: "requireArgument",
            ...
            83535: (C, T, B) => {
                ...
                T.default = function(C) {
                    ...
                    return (0, V.default)(CommandBase, C), (0, U.default)(CommandBase, [{
                        key: "onBeforeRun",
                        value: function onBeforeRun() {
                            var C = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            ...
            92766: (C, T, B) => {
                ...
                T.default = function() {
                    return (0, W.default)(function Deprecation() {
    ...
    __webpack_require__.d = (C, T) => {
        ...
        var C = __webpack_require__(96784),
            ...
            q = C(__webpack_require__(85707)),
            L = C(__webpack_require__(49175)),
            U = function() {
                return (0, B.default)(function AppLoader() {
